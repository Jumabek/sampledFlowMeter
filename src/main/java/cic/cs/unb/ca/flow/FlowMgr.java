...
public class FlowMgr {
    ...
    public static final String WSAF_COUNT_SUFFIX = "_WsafCount.csv";
    public static final String SAMPLED_PKT_COUNT_SUFFIX = "_SPC.txt";
    public static final String EARLY_KICKOUT_COUNT="EarlyKickout.txt";
    public static final String KICKOUT_COUNT="Kickout.txt";
